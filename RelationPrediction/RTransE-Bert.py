...
def main():
    ...
    parser.add_argument("--save_path",
                        default='../save_model/WN18/RTransE-Bert/',
                        type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--test_path",
                        default='../results/WN18/RTransE-Bert/',
                        type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    ...
    entity_emb = np.zeros((ENT_NUM, REL_NUM), dtype=np.float32)
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        test_completion(args, epoch, bert_model, tokenizer, train_triples, test_triples, ent2text, id2ent, ent_embeddings,
                        rel_embeddings, linear, ent_idx, rel_idx, weight_raw, device, "WN18")
